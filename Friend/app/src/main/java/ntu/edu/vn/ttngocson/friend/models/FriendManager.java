package ntu.edu.vn.ttngocson.friend.models;
...
public class FriendManager {
    ...
    public void AddFriend(String id, String name, String BD, String phone, String address){
        friends.add(new Friend(id, name, BD, phone, address));
    }
    public void ModFriend(int index, String id, String name, String BD, String phone, String address){
        friends.set(index, new Friend(id, name, BD, phone, address));
    }
